...
export class EditCategoryComponent implements OnInit {
  ...
  constructor(private http: HttpClient,private location: Location, private router:Router,
              public data:SharedDataService, private snak:MatSnackBar, public dialogRef: MatDialogRef<EditCategoryComponent>,
  ...
  addBanner(){
      ...
      this.http.post(''+this.data.apiDomainPathDash+'editCategory',uploadData) // Get user details
      .subscribe(data => {
        console.log(data);
        this.data.hideLoader();
        this.uplodInfo = data;
