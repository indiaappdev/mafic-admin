...
export class EditProductDetailsComponent implements OnInit {
    ...
    try {
      // this.http.post('https://api.themafic.com/api/MaficDashboard/getSingleProduct', httpbody).subscribe(data => {
        ...
        if (this.res.status == 200) {
          ...
          console.log(this.SingleProductData.categoryId);
          ...
          this.formData = {
            ...
            productSizeWidth: this.productData.product_size_width,
            productSizeHeight: this.productData.product_size_height,
            sizeLength: this.productData.product_size_packaging_length,
            sizeWidth: this.productData.product_size_packaging_width,
            ...
            grossWeight: this.productData.gross_weight,
            netWeight: this.productData.net_weight,
            ...
            materialOrderingAndPaymentTermsId: this.productData.material_ordering_and_payment_terms_id,
            boxingAndPackagingId: this.productData.boxing_and_packaging_id,
            freightId: this.productData.freight_id,
            insuranceId: this.productData.insurance_id,
            incotermId: this.productData.incoterm_id,
            preShipmentInspectionId: this.productData.pre_shipment_inspection
          };
  ...
  openViewContentPopup(event: any, field: string) {
    const selectedId = event.value;
    console.log(selectedId);
    console.log(field);
  ...
  addProductData() {
    ...
    if (this.imgs.length > 0) {
      for (let i = 0; i < this.imgs.length; i++) {
        ...
        uploadData.append('image_' + imageNumber, this.imgs[i]);
      }
